...
data_path = '/lustre/scratch126/cellgen/team298/ar32/farm_job_objects_and_outputs_temp/dis2p_20240703_suo/prepare_data/dis2p_suo_prepped.h5ad'
...
module_name = f'Antony_suoFull_age'
...
wandb_logger = WandbLogger(project=f"Antony_CellDISECT_suoFull_Age", name=model_name)
