...
model = biolord.Biolord(
    adata=adata,
    n_latent=32,
    model_name=f"kang_biolord_basicSettings_nb_{split_key}",
...
model.save(f'/lustre/scratch126/cellgen/team205/aa34/Arian/Dis2P/models/biolord/kang_biolord_basicSettings_nb_{split_key}')
