...
module_name = f'ablation_celldisect_cfW_betterModelSize'
...
wandb_logger = WandbLogger(project=f"CellDISECT_{split_key}_AblationCF_betterModelSize", name=model_name)
