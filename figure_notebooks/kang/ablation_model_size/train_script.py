...
module_name = f'kang_ablation_celldisect_size_all1'
...
model_name =  f'celldisect_{split_key}_AblationSize_{n_layers}_{n_hidden}_{n_latent}'
wandb_logger = WandbLogger(project=f"CellDISECT_{split_key}_AblationSize_Kang", name=model_name)
