...
module_name = f'ablation_celldisect_clfW_all1'
...
model_name =  f'kang_celldisect_{split_key}_clfW_{clf_weight}'
wandb_logger = WandbLogger(project=f"CellDISECT_{split_key}_AblationCLF_Kang", name=model_name)
