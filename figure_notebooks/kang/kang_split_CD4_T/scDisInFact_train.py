...
torch.save(model.state_dict(), '/lustre/scratch126/cellgen/team205/aa34/Arian/Dis2P/models/scDisInfact/' + f"kang_model_40latent_300ep_{split_key}_{Ks}_{lambs}_{batch_size}_{nepochs}_{lr}.pth")
