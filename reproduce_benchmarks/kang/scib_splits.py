...
for cell_type_to_check in ood_cts:
    ...
    # Save the results
    with open(f'/lustre/scratch126/cellgen/team205/aa34/Arian/Dis2P/dis2p_reproducibility/reproduce_benchmarks/kang/scib_results/{cell_type_to_check}.pkl', 'wb') as f:
        pickle.dump(bms, f)
