...
class BenchmarkConfig:
    ...
    results_path: str = '/lustre/scratch126/cellgen/lotfollahi/aa34/mamad-works/models_celldisect/cf_benchmarks/round2'
...
class ModelPredictor:
    ...
    def get_model_folders(self):
        ...
        model_folders = [
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_0.1_beta_0.003_clf_0.05_adv_0.014_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2",
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_0.5_beta_0.003_clf_0.05_adv_0.014_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2",
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_0.8_beta_0.003_clf_0.01_adv_0.014_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2",
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_0.8_beta_0.003_clf_0.05_adv_0.014_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2",
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_0.8_beta_0.003_clf_0.05_adv_0.01_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2",
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_0.8_beta_0.003_clf_0.05_adv_0.1_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2",
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_0.8_beta_0.003_clf_0.05_adv_0.5_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2",
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_0.8_beta_0.003_clf_0.1_adv_0.014_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2",
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_0.8_beta_0.003_clf_0.5_adv_0.014_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2",
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_0.8_beta_0.003_clf_1.0_adv_0.014_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2",
            "HLCA_pretrainAE_0_maxEpochs_1000_split_split_4_reconW_20_cfWeight_1.0_beta_0.003_clf_0.05_adv_0.014_advp_5_n_cf_1_lr_0.003_wd_5e-05_new_cf_True_dropout_0.1_n_hidden_128_n_latent_32_n_layers_2batch_size_256_NoCT_round2"
        ]
    ...
    def _extract_model_name(self, folder_name):
        """Extract a meaningful name from the folder name based on hyperparameter variations"""
    
        # First, identify which hyperparameter group this model belongs to by checking non-default values
    
        # Counterfactual Weight experiments (cf_weight variations)
        if "cfWeight_0.1" in folder_name:
            return "cf_0.1"
        elif "cfWeight_0.5" in folder_name:
            return "cf_0.5" 
        elif "cfWeight_1.0" in folder_name:
            return "cf_1.0"
        
        # Classification Weight experiments (clf_weight variations)
        elif "clf_0.01" in folder_name:
            return "clf_0.01"
        elif "clf_0.1" in folder_name:
            return "clf_0.1"
        elif "clf_0.5" in folder_name:
            return "clf_0.5"
        elif "clf_1.0" in folder_name:
            return "clf_1.0"
        
        # Adversarial Weight experiments (adv_weight variations)
        elif "adv_0.01" in folder_name:
            return "adv_0.01"
        elif "adv_0.1" in folder_name:
            return "adv_0.1"
        elif "adv_0.5" in folder_name:
            return "adv_0.5"
        
        # Default/baseline model (all hyperparameters at default values)
        else:
            return "baseline"
