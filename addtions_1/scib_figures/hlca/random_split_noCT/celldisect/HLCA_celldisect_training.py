...
module_name = f'celldisect_random_split_'
pre_path = f"/lustre/scratch126/cellgen/lotfollahi/aa34/mamad-works/HLCA/training/{module_name}" 
...
model_name = (
    f'HLCA_'
    f'weighted_clf_{arch_dict["weighted_classifier"]}_'
    f'pretrainAE_{train_dict["n_epochs_pretrain_ae"]}_'
    f'maxEpochs_{train_dict["max_epochs"]}_random_split_'
...
wandb_logger = WandbLogger(project=f"HLCA_train_CellDISECT_NoCT_random_split", name=model_name, entity='dis2p')
